...
def get_dbname_test(url='http://192.168.52.128/test2/zvuldrill-master/search.php?search=1', cookie=False, type='search',dbname='zvuldrill', tbcount=3):
...
if __name__ == "__main__" :
    ...
    get_dbname_test(url2, cookie='security_level=0;PHPSESSID=m6cen192df8q6s28g5uls5cbd5', type='int', dbname='bwapp',tbcount=5)
    #get_dbname()
